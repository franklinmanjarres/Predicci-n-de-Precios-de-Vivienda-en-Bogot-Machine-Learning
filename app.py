...
with col2:
    ...
    variables = [
        ...
        "Barrio: Ciudad Usme", "Baños", "Barrio: Otro",
        "Barrio: Santa Bárbara", "Barrio: El Prado", "Barrio: Castilla",
        "Barrio: El Porvenir", "Barrio: Tintal Sur", "Elevadores",
        "Antigüedad", "Barrio: La Uribe"
    ]
    coeficientes = [
    ...
    colores_coef = ["#DD8452" if v > 0 else "#4C72B0" for v in coeficientes]
    ...
    leyenda = [
        mpatches.Patch(color="#DD8452", label="Sube el precio"),
        mpatches.Patch(color="#4C72B0", label="Baja el precio")
    ]
